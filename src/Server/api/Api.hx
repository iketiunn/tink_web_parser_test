 ...
 * Borrowed for testing the code first swagger json generator
 */
...
interface Api {
    ...
    **/
    @:post('/pet/$petId')
    function updatePetWithForm(petId:Int,body: {name:String,status:String}):EmptyResponse;
    ...
    * Returns a map of status codes to quantities
    ...
    FIXME: Too complex, parse it in next version
    **/
    // @:get('/store/inventory')
